...
<head>
  ...
  <title>Pricing - Front Pages | ULAF Admin</title>
        ...
        <div class="col-lg mb-md-0 mb-4">
          <div class="card border rounded shadow-none">
            <div class="card-body">
              ...
              <a href="payment-page.php" class="btn btn-label-success d-grid w-100">Your Current Plan</a>
            </div>
          </div>
        </div>
        ...
        <div class="col-lg mb-md-0 mb-4">
          <div class="card border-primary border shadow-none">
            <div class="card-body position-relative">
              ...
              <a href="payment-page.php" class="btn btn-primary d-grid w-100">Upgrade</a>
            </div>
          </div>
        </div>
        ...
        <div class="col-lg">
          <div class="card border rounded shadow-none">
            <div class="card-body">
              ...
              <a href="payment-page.php" class="btn btn-label-primary d-grid w-100">Upgrade</a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="position-relative">
        <div class="d-flex justify-content-between flex-column-reverse flex-lg-row align-items-center py-4 px-5">
          <div class="text-center text-lg-start mt-2 ms-3">
            ...
            <a href="payment-page.php" class="btn btn-primary mt-4 mb-2">Start 14-day FREE trial</a>
          </div>
          <!-- image -->
          <div class="text-center">
            <img src="../../assets/img/illustrations/girl-with-laptop.png" class="img-fluid me-lg-5 pe-lg-1 mb-3 mb-lg-0" alt="Api Key Image" width="202" />
          </div>
        </div>
      </div>
    </div>
            ...
            <table class="table table-striped text-center mb-0">
              ...
              <tbody>
                ...
                <tr>
                  <td></td>
                  <td>
                    <a href="payment-page.php" class="btn text-nowrap btn-label-primary">Choose Plan</a>
                  </td>
                  <td>
                    <a href="payment-page.php" class="btn text-nowrap btn-primary">Choose Plan</a>
                  </td>
                  <td>
                    <a href="payment-page.php" class="btn text-nowrap btn-label-primary">Choose Plan</a>
                  </td>
