...
<head>
  ...
  <title>Landing Page - Front Pages | ULAF Admin</title>
  ...
  <div data-bs-spy="scroll" class="scrollspy-example">
    ...
    <section id="hero-animation">
      <div id="landingHero" class="section-py landing-hero position-relative">
        <img src="../../assets/img/front-pages/backgrounds/hero-bg.png" alt="hero background" class="position-absolute top-0 start-50 translate-middle-x object-fit-contain w-100 h-100" data-speed="1" />
        <div class="container">
          ...
          <div id="heroDashboardAnimation" class="hero-animation-img">
            <a href="../vertical-menu-template/app-ecommerce-dashboard.php" target="_blank">
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <div class="d-grid mt-4 pt-3">
                  <a href="payment-page.php" class="btn btn-label-primary">Get Started</a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="col-xl-4 col-lg-6">
            <div class="card border border-primary shadow-lg">
              ...
              <div class="card-body">
                ...
                <div class="d-grid mt-4 pt-3">
                  <a href="payment-page.php" class="btn btn-primary">Get Started</a>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="container">
        <div class="row align-items-center gy-5 gy-lg-0">
          <div class="col-lg-6 text-center text-lg-start">
            ...
            <a href="payment-page.php" class="btn btn-lg btn-primary">Get Started</a>
          </div>
        ...
        <div class="row gy-4">
          <div class="col-lg-5">
            <div class="contact-img-box position-relative border p-2 h-100">
              <img src="../../assets/img/front-pages/icons/contact-border.png" alt="contact border" class="contact-border-img position-absolute d-none d-md-block scaleX-n1-rtl" />
