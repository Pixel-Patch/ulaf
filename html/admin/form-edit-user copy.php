                  ...
                  <div class="card-body">
                    <form id="formValidationExamples" class="row g-3">
                      ...
                      <div class="col-md-6">
                        ...
                        <input type="text" id="edituserid" name="edituserid" class="form-control" value="<?php echo htmlspecialchars($user['User_ID'], ENT_QUOTES, 'UTF-8'); ?>" aria-label="24-0001" />
                        <input type="hidden" id="currentuserid" value="<?php echo htmlspecialchars($user['User_ID'], ENT_QUOTES, 'UTF-8'); ?>">
                        <div id="edituseridFeedback" class="invalid-feedback"></div>
                      </div>

                      <div class="col-md-6">
                        <label class="form-label" for="editfullname">Full Name</label>
                        <input type="text" id="editfullname" class="form-control" value="<?php echo htmlspecialchars($user['FullName'], ENT_QUOTES, 'UTF-8'); ?>" name="editfullname" aria-label="John Doe" />
                      </div>

                      <div class="col-md-6">
                        <label class="form-label" for="editusername">Username</label>
                        <input type="text" id="editusername" class="form-control" value="<?php echo htmlspecialchars($user['Username'], ENT_QUOTES, 'UTF-8'); ?>" aria-label="jdoe1" name="editusername" />
                        <input type="hidden" id="currentusername" value="<?php echo htmlspecialchars($user['Username'], ENT_QUOTES, 'UTF-8'); ?>">
                      ...
                      <div class="col-md-6">
                        ...
                        <input type="email" class="form-control" id="editemail" name="editemail" value="<?php echo htmlspecialchars($user['Email'], ENT_QUOTES, 'UTF-8'); ?>" placeholder="example@example.com" aria-label="example@example.com" required />
                        <input type="hidden" id="currentemail" value="<?php echo htmlspecialchars($user['Email'], ENT_QUOTES, 'UTF-8'); ?>">
                      ...
                      <div class="col-md-6">
                        ...
                        <select id="editcollege" name="editcollege" class="form-select">
                          ...
                          <optgroup label="Undergraduate">
                            <!-- Add options for undergraduate colleges -->
                          </optgroup>
                          <optgroup label="Graduate">
                            <!-- Add options for graduate colleges -->
                          </optgroup>
                          <optgroup label="Other Curricular Offerings">
                            <!-- Add options for other curricular offerings -->
                          </optgroup>
                        </select>
                      </div>
                      ...
                      <div class="col-md-6">
                        ...
                        <select id="editcourse" name="editcourse" class="form-select">
                          ...
                          <!-- Add options for courses based on the selected college -->
                        </select>
                      </div>
                      ...
                      <div class="col-md-12">
                        ...
                        <input class="form-control" id="editclsuaddress" name="editclsuaddress" value="<?php echo htmlspecialchars($user['CLSU_Address'], ENT_QUOTES, 'UTF-8'); ?>" rows="3"></input>
                      </div>
                      ...
                      <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="editcontact" name="editcontact" value="<?php echo htmlspecialchars($user['Contact'], ENT_QUOTES, 'UTF-8'); ?>" placeholder="+63 988 888 8888" aria-label="+63 988 888 8888" required />
                      </div>

                      <div class="col-md-6">
                        <label class="form-label" for="edithomeaddress">Home Address</label>
                        <textarea class="form-control" id="edithomeaddress" name="edithomeaddress" placeholder="123 Main St, Anytown, PH" aria-label="123 Main St, Anytown, USA" required><?php echo htmlspecialchars($user['Home_Address'], ENT_QUOTES, 'UTF-8'); ?></textarea>
                      </div>

                      <div class="col-md-6">
                        <label class="form-label" for="editlinks">Other Social Links (separated by commas)</label>
                        <textarea class="form-control" id="editlinks" name="editlinks" placeholder="m.me/username, viber://add?phonenumber, t.me/username" aria-label="m.me/username, viber://add?phonenumber, t.me/username" required><?php echo htmlspecialchars($user['Social_Links'], ENT_QUOTES, 'UTF-8'); ?></textarea>
                      </div>
