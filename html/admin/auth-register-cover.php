              ...
              <div id="account-details-validation" class="content">
                ...
                <div class="row g-3">
                  <div class="col-sm-6">
                    ...
                    <input type="text" name="formValidationUserID" id="formValidationUserID" class="form-control" placeholder="24-0001" required />
                  </div>

                  <div class="col-sm-6">
                    <label class="form-label" for="formValidationUsername">Username</label>
                    <input type="text" name="formValidationUsername" id="formValidationUsername" class="form-control" placeholder="johndoe" required />
                  </div>
                  <div class="col-sm-12">
                    <label class="form-label" for="formValidationFullname">Fullname</label>
                    <input type="text" name="formValidationFullname" id="formValidationFullname" class="form-control" placeholder="Xavier Carl  A. Dela Cruz Sr." required />
                  </div>
