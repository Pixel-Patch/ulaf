...
$(function () {
  ...
  if (dt_user_table.length) {
    var dt_user = dt_user_table.DataTable({
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            ...
            var roleBadgeObj = {
              ...
              'AdminStaff': '<span class="badge badge-center rounded-pill bg-label-primary w-px-30 h-px-30 me-2"><i class="ti ti-chart-pie-2 ti-sm"></i></span>'
            };
      ...
      order: [[1, 'desc']], // Order by full_name
      dom:
        '<"row me-2"' +
        '<"col-md-2"<"me-3"l>>' +
